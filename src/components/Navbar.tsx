      ...
      <div className="container mx-auto px-4">
        ...
        <div className="hidden md:flex items-center justify-between py-3 gap-6">
          ...
          <a href={navbar.leftLogoHref || "/"} className="flex-shrink-0">
            <img alt="Trust Logo" className="h-14 w-auto object-contain" src={navbar.leftLogoUrl || trustLogo} />
          </a>
          ...
          <a href={navbar.rightLogoHref || "/"} className="flex-shrink-0">
            <img alt="College Logo" className="h-14 w-auto object-contain" src={navbar.rightLogoUrl || collegeLogo} />
          </a>
        </div>
        ...
        <div className="md:hidden py-3">
          <div className="flex items-center justify-between gap-4">
            <a href={navbar.leftLogoHref || "/"} className="flex-shrink-0">
              <img src={navbar.leftLogoUrl || trustLogo} alt="Trust Logo" className="h-12 w-auto object-contain" />
            </a>
            ...
            <a href={navbar.rightLogoHref || "/"} className="flex-shrink-0">
              <img src={navbar.rightLogoUrl || collegeLogo} alt="College Logo" className="h-12 w-auto object-contain" />
            </a>
          </div>
