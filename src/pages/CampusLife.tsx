import { FlaskConical, BookOpen, Trophy, Music, Heart, Users, Calendar } from 'lucide-react';
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {campusLife.sections.map((section, index) => (
              <Card key={index} className="card-hover">
                <CardHeader>
                  <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center mb-4 text-primary">
                    {iconMap[section.icon] || <BookOpen size={32} />}
                  </div>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="space-y-4">
                  {campusLife.saturdayActivities.map((activity, index) => (
      ...
      <section className="py-16 bg-muted">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="aspect-square rounded-lg overflow-hidden">
              <img
                src="https://images.unsplash.com/photo-1532094349884-543bc11b234d?w=400"
                alt="Laboratory"
                className="w-full h-full object-cover hover:scale-110 transition-transform duration-300"
              />
            </div>
